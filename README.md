...
- **1,276 tests**, none of which call the model or need a GPU; 25 want the
...
`uv run pytest` runs the 1,276 tests with no model, no GPU and no dataset.
...
**1,276 tests.** 1,249 of them run on a clean checkout in CI — they build their
