...
- **1,268 tests**, none of which call the model or need a GPU; 25 want the
...
[above](#the-planner-was-graded-on-questions-its-author-never-saw); whether the
...
**1,268 tests.** 1,243 of them run on a clean checkout in CI — they build their
