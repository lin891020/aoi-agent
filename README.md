...
| **Verification** | 1,464 tests, no model or GPU required. Every threshold cites its source; every figure names the script that produced it. |
...
runs all 1,439 dataset-free tests in about 40 seconds — no model, no GPU, no
...
**1,464 tests.** 1,439 run on a clean checkout in CI — they build their own
