...
| **Verification** | 1,353 tests, no model or GPU required. Every threshold cites its source; every figure names the script that produced it. |
...
**1,353 tests.** 1,328 of them run on a clean checkout in CI — they build their
