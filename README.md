...
| **Verification** | 1,278 tests, no model or GPU required. Every threshold cites its source; every figure names the script that produced it. |
...
**1,278 tests.** 1,249 of them run on a clean checkout in CI — they build their
