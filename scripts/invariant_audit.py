...
REGISTRY: tuple[Entry, ...] = (
    ...
    Entry(
        ...
        tests=(
            ...
            "tests/test_graph.py::test_an_unparseable_verdict_in_the_explanation_band_is_decided_anyway",
    ...
    Entry(
        ...
        status=ENFORCED,
        tests=(
            "tests/test_class_escape.py::test_a_class_that_admits_no_instance_exceeds_the_budget_it_is_averaged_into",
            "tests/test_class_escape.py::test_the_escapes_are_confident_errors_not_uncertain_ones",
